...
export const Timeline = ({ data }) => {
  ...
  return (
    <div
      className="w-full dark:bg-[#202020] font-sans md:px-10"
      ref={containerRef}
    >
      <div className="max-w-7xl mx-auto pb-5 pt-10 md:pt-16 px-8 md:px-8 lg:px-10 text-center md:text-left">
        <h1 className="text-5xl md:text-7xl xl:text-9xl text-black dark:text-white max-w-4xl font-display">
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-3 md:left-3 w-10 rounded-full bg-[#202020] flex items-center justify-center">
                <div className="h-2 w-2 md:h-4 md:w-4 rounded-full bg-teal border border-neutral-300 dark:border-white p-1.5 md:p-2" />
              </div>
        ...
        <div
          ...
          className="absolute md:left-8 left-[31px] top-0 overflow-hidden w-[2px] bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-[0%] via-neutral-200 dark:via-neutral-700 to-transparent to-[99%]  [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)] "
        >
          <motion.div
            style={{
